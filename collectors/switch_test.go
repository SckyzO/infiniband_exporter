...
func TestSwitchCollectorFull(t *testing.T) {
	...
	expected := `
		...
		infiniband_switch_port_dli_mapping_errors_total{guid="0x506b4b03005c2740",port="1",switch="iswr0l1"} 0
		infiniband_switch_port_dli_mapping_errors_total{guid="0x7cfe9003009ce5b0",port="1",switch="iswr1l1"} 0
		infiniband_switch_port_dli_mapping_errors_total{guid="0x7cfe9003009ce5b0",port="2",switch="iswr1l1"} 0
		# HELP infiniband_switch_port_excessive_buffer_overrun_errors_total Infiniband switch port ExcessiveBufferOverrunErrors
		# TYPE infiniband_switch_port_excessive_buffer_overrun_errors_total counter
		infiniband_switch_port_excessive_buffer_overrun_errors_total{guid="0x506b4b03005c2740",port="1",switch="iswr0l1"} 0
		infiniband_switch_port_excessive_buffer_overrun_errors_total{guid="0x7cfe9003009ce5b0",port="1",switch="iswr1l1"} 0
